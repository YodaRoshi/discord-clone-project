...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/newuser/PythonCourse/discord-clone-project/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/newuser/PythonCourse/discord-clone-project/env/bin/deactivate.nu'
